...
const navItems: NavItem[] = [
  ...
  { href: "#", label: "Lớp học", icon: <ClassroomIcon /> },
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white border-r border-zinc-200 dark:bg-zinc-900 dark:border-zinc-800 flex flex-col">
      {/* Logo */}
